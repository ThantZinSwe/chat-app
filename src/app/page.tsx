        ...
        <div className="flex flex-col py-8 pl-6 pr-2 w-64 bg-white flex-shrink-0">
          ...
          <div className="flex flex-col items-center bg-primary-100 border border-gray-200 mt-4 w-full py-6 px-4 rounded-lg">
            ...
            <div className="flex flex-row items-center mt-3">
              <div className="flex flex-col justify-center h-4 w-8 bg-primary-500 rounded-full">
                ...
                <div className="grid grid-cols-12 gap-y-2">
                  ...
                  <div className="col-start-1 col-end-8 p-3 rounded-lg">
                    <div className="flex flex-row items-center">
                      ...
                      <div className="relative ml-3 text-sm bg-white py-2 px-4 shadow rounded-xl">
                        <div className="flex flex-row items-center">
                          <button className="flex items-center justify-center bg-primary-600 hover:bg-primary-800 rounded-full h-8 w-10">
                            <svg
